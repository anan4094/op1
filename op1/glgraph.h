...
void ptriangles(unsigned char*map,int *dem,int w,int h,pviewpoint _vs,int size);
void polyFill(unsigned char*map,int *dem,int w,int h,pviewpoint o,int length = 3);
#endif
